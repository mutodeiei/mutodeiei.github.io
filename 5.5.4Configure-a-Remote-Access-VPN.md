...
# Start Lab
  ...
  + 2.สร้าง Server Certificate ใหม่ ไปที่ vpn > Wizard > Type of Sever > เลือก Local User Access > กด Next 
    ...
    + Organization: CorpNet
     ...
     การสร้าง Certificate Authority (CA) ตั้งค่าเพื่อเป็น “หน่วยออกใบรับรอง” ให้ระบบ VPNใช้สำหรับออก Certificate ให้ Server และ Client เพื่อให้เชื่อมต่อกันได้อย่างปลอดภัย
ช่วยยืนยันตัวตนและเข้ารหัสข้อมูล ป้องกันการปลอมแปลงหรือดักฟัง
...
การตั้งค่า Firewall Rule และ OpenVPN Rule คือการ “เปิดประตูให้ VPN ใช้งานได้ครบวงจร”Firewall Rule ทำหน้าที่เปิดทางจาก Internet ให้เครื่องภายนอกสามารถเชื่อมต่อเข้ามาที่ VPN Server ได้OpenVPN Rule ทำหน้าที่อนุญาตให้ผู้ใช้ที่เชื่อมต่อ VPN แล้ว สามารถเข้าถึงระบบและเครือข่ายภายในบริษัทได้
  ...
  (User Auth) จากนั้นกด > save
     ...
     การตั้งค่า Remote Access (User Auth) คือการกำหนดให้ OpenVPN Server รองรับการเชื่อมต่อจากผู้ใช้นอกองค์กร โดยต้อง ล็อกอินด้วย Username/Password ก่อนจึงจะเข้าใช้งานได้ ช่วยควบคุมสิทธิ์และเพิ่มความปลอดภัยในการเข้าถึงเครือข่ายภายใน
